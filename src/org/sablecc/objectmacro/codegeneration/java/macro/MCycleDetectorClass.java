...
public class MCycleDetectorClass {
  ...
  public String toString() {
    ...
    sb.append(System.getProperty("line.separator"));
    sb.append(System.getProperty("line.separator"));
    sb.append("    private Set<Macro> macros;");
    sb.append(System.getProperty("line.separator"));
    sb.append(System.getProperty("line.separator"));
    ...
    sb.append(System.getProperty("line.separator"));
    sb.append(System.getProperty("line.separator"));
    sb.append("        this.macros = new LinkedHashSet<>();");
    sb.append(System.getProperty("line.separator"));
    ...
    sb.append(System.getProperty("line.separator"));
    sb.append(System.getProperty("line.separator"));
    sb.append("        if(this.macros.contains(macro)){");
    sb.append(System.getProperty("line.separator"));
    sb.append("            return;");
    sb.append(System.getProperty("line.separator"));
    sb.append("        }");
    sb.append(System.getProperty("line.separator"));
    sb.append(System.getProperty("line.separator"));
    sb.append("        this.macros.add(macro);");
    sb.append(System.getProperty("line.separator"));
    sb.append(System.getProperty("line.separator"));
    sb.append("        for(Macro child : macro.getChildren()){");
    sb.append(System.getProperty("line.separator"));
    sb.append("            if(child == this.receiver){");
    sb.append(System.getProperty("line.separator"));
    sb.append("                throw ObjectMacroException.cyclicReference(child.getClass().getSimpleName());");
    sb.append(System.getProperty("line.separator"));
    sb.append("            }");
    sb.append(System.getProperty("line.separator"));
